...
/* eslint-disable */
/*!
 * Float Labels JS adapted version for bootstrap 4
 * @author: Klaus Mergen
 *
 * @version: 3.3.8
...
;(function (window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        /** @return Element */
        createEl_: function createEl_(tag, attributes) {
        ...
        /** @return null|void */
        floatLabel_: function floatLabel_(el, rebuild) {
            var self = this;
        ...
        /** @return string|false */
        getLabel_: function getLabel_(el) {
        ...
        /** @return string */
        getLabelText_: function getLabelText_(labelEl, el) {
        ...
        /** @return void */
        handleEvents_: function handleEvents_(el, action) {
        ...
        /** @return bool */
        hasParent_: function hasParent_(el) {
            return el.parentNode.classList.contains(this.prefixed_('wrap'));
        },

        /** @return bool */
        isString_: function isString_(str) {
            return Object.prototype.toString.call(str) === "[object String]";
        },

        /** @return bool */
        isValidField_: function isValidField_(el) {
        ...
        /** @return void */
        loop_: function loop_(elCallback, fieldCallback) {
            var self = this;
        ...
        /** @return void */
        onBlur_: function onBlur_(ev) {
            var wrapper = ev.target.closest('.fl-wrap');
            wrapper.classList.remove(this.prefixed_('has-focus'));
        },

        /** @return void */
        onInput_: function onInput_(ev) {
            var wrapper = ev.target.closest('.fl-wrap');
            wrapper.classList[this.addRemove_(ev.target.value.length)](this.prefixed_('is-active'));
        },

        /** @return void */
        onFocus_: function onFocus_(ev) {
            var wrapper = ev.target.closest('.fl-wrap');
            wrapper.classList.add(this.prefixed_('has-focus'));
        },
        ...
        /** @return string */
        prefixed_: function prefixed_(value) {
            return this.config_[this.current_].prefix + value;
        },

        /** @return void */
        removeClasses_: function removeClasses_(el) {
        ...
        /** @return void */
        resetPlaceholder_: function resetPlaceholder_(el) {
        ...
        /** @return void */
        setLabel_: function setLabel_(labelEl, el) {
            var self = this;
        ...
        /** @return void */
        setPlaceholder_: function setPlaceholder_(labelEl, el) {
            var self = this;
            var placeholderText = el.getAttribute('placeholder');
        ...
        /** @return void */
        setSelectPlaceholder_: function setSelectPlaceholder_(el, placeholderText) {
        ...
        /** @return void */
        wrapLabel_: function wrapLabel_(labelEl, el) {
            // In original code a fl wrapper is created, but we use the existing form->field wrapper
            var self = this;
